...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
    <img src="images/GCBlogo.png" width="30" height="30" class="d-inline-block align-top" alt="">
...
{
  if (!$con->query("insert into useraccounts (name,natId,accountNo,accountType,city,address,email,password,balance,source,number,branch) values ('$_POST[name]','$_POST[natId]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table">
      <tbody>
        <tr>
          <form method="POST">
          <th>Name</th>
          <td><input type="text" name="name" class="form-control input-sm" pattern="[A-Za-z]+" title="type letters only" required></td>
		  
          <th>NAT ID</th>
          <td><input type="number" name="natId" class="form-control input-sm" required></td>
        </tr>
        <tr>
        ...
        <tr>
          <th>City</th>
          <td><input type="text" name="city" class="form-control input-sm" pattern="[A-Za-z]+" title="type letters only" required></td>
          <th>Address</th>
        ...
        <tr>
          <th>Deposit</th>
          <td><input type="number" name="balance" min="50" class="form-control input-sm" required></td>
          <th>Source of income</th>
          <td><input type="text" name="source" class="form-control input-sm" pattern="[A-Za-z]+" title="type letters only" required></td>
        </tr>
        <tr>
